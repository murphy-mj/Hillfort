...
class UserListHillforts : Fragment() ,AnkoLogger, PlacemarkSelectionListener {
  ...
  //  lateinit var placemarksListFrag : ArrayList<HillfortModel>
        ...
        root.swiperefresh.setOnRefreshListener(object : SwipeRefreshLayout.OnRefreshListener {
            override fun onRefresh() {
              ...
              //  placemarksListFrag = app.pObj.findAll2()
                getAllUserPlacemarks(userSelected)
            }
        })
    }
             ...
             //      hideLoader(loader)
                    ...
                    children.forEach {
                        ...
                        root.recyclerViewF.adapter =
                            PlacemarkSelectionAdapter(placemarksList, this@UserListHillforts)
    ...
    override fun onResume() {
        super.onResume()
        info("On Resume selected User : ${userSelected}")
        getAllUserPlacemarks(userSelected)
    }
