...
class StatsAdminSelectUser : Fragment() ,AnkoLogger, UserListener {
  ...
  //  lateinit var placemarksListFrag : ArrayList<HillfortModel>
    ...
    override fun onCreateView(
       ...
       // userSelected1 = arguments!!.getString("selectedUser").toString()
        setSwipeRefresh()
    ...
    override fun onUserClick(user: UserModel) {
     ...
     //   args.putParcelable("selectedUser",user )
        ...
        var frag = StatsOtherFragment.newInstance()
        frag.arguments=args
        activity!!.supportFragmentManager.beginTransaction()
            .replace(R.id.homeFrame,frag )
            .addToBackStack("StatsAdminSelectUser")
            .commit()
    }
                    ...
                    children.forEach {
                      ...
                      //  val userId = it.value as String
                        ...
                        root.recyclerViewU.adapter =
                            UserAdapter(userList, this@StatsAdminSelectUser)
