...
import com.me.hillfort.views.hillfort.PlacemarkPresenter


//import kotlinx.android.synthetic.main.activity_edit_location.*


class PlacemarkAddView : BaseView(), AnkoLogger {

  lateinit var presenter: PlacemarkAddPresenter
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    presenter = initPresenter (PlacemarkAddPresenter(this)) as PlacemarkAddPresenter
